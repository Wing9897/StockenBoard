...
fn parse_okx_dex_symbol(symbol: &str) -> (String, String, u32) {
    ...
    match upper.as_str() {
        ...
        "ETH" | "WETH" => (
            CHAIN_ETH.into(),
            "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee".into(),
            18,
        ),
        "WBTC" => (
            CHAIN_ETH.into(),
        ...
        "LINK" => (
            CHAIN_ETH.into(),
            "0x514910771af9ca656af840dff83e8264ecf986ca".into(),
            18,
        ),
        "AAVE" => (
            CHAIN_ETH.into(),
            "0x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9".into(),
            18,
        ),
        "PEPE" => (
            CHAIN_ETH.into(),
        ...
        "SHIB" => (
            CHAIN_ETH.into(),
            "0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce".into(),
            18,
        ),
        // BSC
        "BNB" | "WBNB" => (
        ...
        "CAKE" => (
            CHAIN_BSC.into(),
            "0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82".into(),
            18,
        ),
        // Solana
        "SOL" | "WSOL" => (
        ...
        "JUP" => (
            CHAIN_SOLANA.into(),
            "JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN".into(),
            6,
        ),
        "BONK" => (
            CHAIN_SOLANA.into(),
        ...
        "WIF" => (
            CHAIN_SOLANA.into(),
            "EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm".into(),
            6,
        ),
        // Polygon
        "MATIC" | "POL" => (
        ...
        "ARB" => (
            CHAIN_ARBITRUM.into(),
            "0x912ce59144191c1204e64559fe8253a0e49e6548".into(),
            18,
        ),
        // 默認：假設 Ethereum 合約地址
...
impl DataProvider for OkxDexProvider {
    ...
    async fn fetch_price(&self, symbol: &str) -> Result<AssetData, String> {
        ...
        Ok(AssetDataBuilder::new(symbol, "okx_dex")
            .price(price)
            .currency("USD")
