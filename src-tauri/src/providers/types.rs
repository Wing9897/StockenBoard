...
impl AssetDataBuilder {
    ...
    pub fn price(mut self, p: f64) -> Self {
        self.data.price = p;
        self
    }
    pub fn currency(mut self, c: &str) -> Self {
        self.data.currency = c.to_string();
        self
    }
    pub fn change_24h(mut self, v: Option<f64>) -> Self {
        self.data.change_24h = v;
        self
    }
    pub fn change_percent_24h(mut self, v: Option<f64>) -> Self {
        self.data.change_percent_24h = v;
        self
    }
    pub fn high_24h(mut self, v: Option<f64>) -> Self {
        self.data.high_24h = v;
        self
    }
    pub fn low_24h(mut self, v: Option<f64>) -> Self {
        self.data.low_24h = v;
        self
    }
    pub fn volume(mut self, v: Option<f64>) -> Self {
        self.data.volume = v;
        self
    }
    pub fn market_cap(mut self, v: Option<f64>) -> Self {
        self.data.market_cap = v;
        self
    }

    pub fn extra_f64(mut self, key: &str, val: Option<f64>) -> Self {
        if let Some(v) = val {
            self.extra.insert(key.to_string(), serde_json::json!(v));
        }
        self
    }
    ...
    pub fn build(mut self) -> AssetData {
        self.data.extra = if self.extra.is_empty() {
            None
        } else {
            Some(self.extra)
        };
...
/// O(1) 查找單個 provider info — 各 provider module 透過 `use super::types::*` 使用
...
pub fn provider_info_or_panic(id: &str) -> ProviderInfo {
    get_provider_info(id).unwrap_or_else(|| {
        panic!("provider info '{id}' not registered in build_all_provider_info()")
    })
}
...
fn build_all_provider_info() -> Vec<ProviderInfo> {
    vec![
        ...
        pi(
            ...
            false,
            false,
            "Free 10-30 calls/min; w/ key 30/min",
            "bitcoin, ethereum",
            &["price", "change_24h", "volume", "market_cap"],
            60000,
            20000,
        ),
        pi(
            ...
            false,
            false,
            "Free 10k credits/mo, 10 calls/min",
            "BTC, ETH",
            &["price", "change_24h", "volume", "market_cap"],
            60000,
            30000,
        ...
        pi(
            ...
            false,
            false,
            "Free 100 req/mo; paid unlimited",
            "AAPL, MSFT",
            &["price", "high_24h", "low_24h", "volume"],
            600000,
            60000,
        ),
        pi(
            ...
            false,
            false,
            "Free 20 calls/day; paid unlimited",
            "AAPL.US, TSLA.US",
            &["price", "change_24h", "high_24h", "low_24h", "volume"],
            300000,
            30000,
        ...
        pi(
            ...
            false,
            true,
            "Free 60 calls/min, no daily limit",
        ...
        pi(
            ...
            false,
            true,
            "Free 5 calls/min; paid unlimited",
            "AAPL, X:BTCUSD",
            &["price", "change_24h", "high_24h", "low_24h", "volume"],
            60000,
            15000,
        ...
        pi(
            ...
            false,
            true,
            "Free 800 calls/day, 8/min; paid more",
            "AAPL, BTC/USD",
            &["price", "change_24h", "high_24h", "low_24h", "volume"],
            15000,
            8000,
        ...
        pi(
            ...
            false,
            false,
            "Free $25 credits; 100 data points/credit",
            "BTC, ETH, AAPL",
            &["price"],
            60000,
            30000,
        ...
        pi(
            ...
            false,
            false,
            "Free 500 req/mo; paid 10k+/mo, 30+ markets",
            "AAPL, MSFT, 2330.TW",
            &["price", "change_24h", "high_24h", "low_24h", "volume"],
            120000,
            30000,
        ...
        pi(
            ...
            false,
            false,
            "API Key required (portal.jup.ag free); Solana DEX aggregator",
            "SOL, JUP, BONK, WIF, mint_address",
            &["price", "change_24h"],
            10000,
            5000,
        ),
        pi(
            ...
            false,
            false,
            "API Key required (OKX Web3 Portal free); multi-chain DEX aggregator",
            "ETH, SOL, BNB, eth:0x..., sol:mint",
            &["price"],
            15000,
            10000,
        ),
        ...
        pi(
            ...
            false,
            false,
            "API Key required; Solana DEX AMM",
        ...
        pi(
            ...
            false,
            false,
            "API Key required (The Graph); EVM DEX aggregator",
            "protocol:pool:tokenFrom:tokenTo",
            &["price"],
            15000,
            10000,
        ),
...
fn pi(
    ...
    ProviderInfo {
        ...
        requires_api_secret: secret,
        supports_websocket: ws,
        optional_api_key: opt_key,
        free_tier_info: free.to_string(),
        symbol_format: fmt.to_string(),
